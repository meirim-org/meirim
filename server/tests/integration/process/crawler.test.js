...
describe('Crawler scraped data', function() {
	...
	it('should update existing plan data', async function() {
		...
		assert.deepEqual(plan.attributes.data, { 'OBJECTID':17738,'PLAN_COUNTY_NAME':'גם סח\'נין','PLAN_COUNTY_CODE':7501,'ENTITY_SUBTYPE_DESC':'תכנית מתאר מקומית מעודכנת','PL_NUMBER':'262-0907907','PL_NAME':'שינוי בהוראות וזכויות הבניה בית עטיה אבו סאלח - סכנין - מעודכן','PL_AREA_DUNAM':0.657,'DEPOSITING_DATE':null,'PL_DATE_8':null,'PL_LANDUSE_STRING':'מגורים ג','STATION_DESC':'סמכות מקומית בתהליך מעודכן','PL_BY_AUTH_OF':4,'PL_URL':'https://mavat.iplan.gov.il/SV4/1/2005099108/310','SHAPE_AREA':656.2206166598945,'QUANTITY_DELTA_120':1,'QUANTITY_DELTA_125':1,'LAST_UPDATE':'20201003092719      ','PL_ORDER_PRINT_VERSION':2,'PL_TASRIT_PRN_VERSION':2, plan_new_mavat_url: 'https://mavat.iplan.gov.il/SV4/1/2005099108/310', MP_ID: '2005099108' }, 'updated read plan data is correct');
