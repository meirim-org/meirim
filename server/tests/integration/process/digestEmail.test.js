...
describe('Digest Plan Emails', function() {
	const tables = ['alert', 'person', 'plan', 'notification', 'staticmap'];
...
// static maps were created

// change to dynamic- ? What happened over the last week and that's it?
