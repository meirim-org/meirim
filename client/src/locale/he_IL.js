...
const HEBREW_TRANSLATION = {
	...
	fundingExplanation: 'ככל שהמערכת החינמית שלנו מתפתחת ונרשמים אליה יותר אנשים, עלויות התחזוקה שלה גדלות ומעבר לזה, יש לנו עוד כל כך הרבה חלומות. תמכו בנו כדי שנכל להמשיך ולהנגיש יותר מידע ויותר טוב, להגיע לכמה שיותר אנשים ולבסס קהילה ולשנות את כללי המשחק לטובת הציבור הרחב. תמיכה קבועה בכל סכום יכול לעזור לנו לבסס את הפעילות בצורה ברמת קיימא. גם 10 שקלים בחודש יכולים לחולל פלאים.',
