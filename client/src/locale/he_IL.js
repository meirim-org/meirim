...
ערר ניתן להגיש מטעמים שונים, בין היתר, בשל פגיעה אקולוגית, ערך היסטורי, חברתי או עירוני הקשור בעץ.`,
    ...
    treesHelperTextB: '.\nהכניסו שם יישוב וצפו ברישיונות הכריתה:',
    plansHelperText:
        'تتطلب التغييرات في الحيز الذي نعيش به، مثل بناء حي جديد أو بناء مصنع أو تطوير حديقة، وضع خطط ومخططات. لجان التخطيط والبناء تقوم بالإشراف على الخطط، وبالمقابل تصادق عليها أو ترفضها. أدخل عنوانًا واكتشف المخططات المجاورة لك:',
    searchAddressOrCity: 'חפש כתובת או עיר',
    showPlans: 'הצג תוכניות:',
    inProgress: 'בתהליך',
    approved: 'מאושרות',
