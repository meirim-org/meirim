...
export default {
    ...
    fundingStatsTitle:
        "עם קצת פוש מכם נוכל להנגיש יותר מידע ויותר תוכניות, ויחד נשנה את התכנון בישראל",
    ...
    fundingAboutUs:
        "הפעילות שלנו מבוססת על מתנדבים שנושא התכנון בוער בהם, שמאמינים בשקיפות בתהליכי התכנון ופועלים להגביר את המעורבות של תושבים במערכות התכנון.",
