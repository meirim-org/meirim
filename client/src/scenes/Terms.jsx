		...
		<Wrapper>
			<div className="container">
                    ...
                    <p style={{'font-size': '18px'}}>
                        ...
                        <br/>
                        1.7. תנאי הסכם זה נכונים לכל שימוש במערכת ובאתר, והשימוש במונח אחד נכון גם למונח השני, בשינויים המתחייבים. על אף האמור, על גיוס תרומות המתבצע באמצעות האתר יחולו בנוסף לתנאי שימוש אלו גם תנאי תקנון גיוס התרומות <Link to="/funding/">הזמין בעמוד התמיכה</Link>.
                        <br/>
