...
class TreePermits extends Component {
    ...
    loadTrees(pageNumber, filterPlaces) {
        ...
        api.get('/tree?page=' + pageNumber + '&PLACE=' + filterPlaces.join(','))
            .then((result) => {
                this.setState({
                    hasMore:
                        result.pagination.page < result.pagination.pageCount,
                    noData:
                        this.state.treePermits.length + result.data.length ===
                        0,
                    pageNumber,
                    filterPlaces,
    ...
    componentDidMount() {
        ...
        this.clearTitle = setTitle(t.treePermits);
    }
            ...
            <Wrapper me={me}>
                <div className="container">
                    <FilterAutoCompleteMultiple
                        ...
                        onFilterChange={this.handlePlaceFilterChange.bind(this)}
                    />
                    ...
                    <div> </div>
                    <br />
                    <GridList cellHeight={500} className="gridList" cols={1}>
                                ...
                                >
                                    <CardActionArea className="card-action-area">
                                        ...
                                        <CardContent className="card-content">
                                            ...
                                            <this.CardContentAddress
                                                tree={tree}
                                            />
                                            <this.CardContentField
                                                field={tree.action}
                                                fieldBold="פעולה:"
                                            />
                                            <this.CardContentField
                                                field={tree.reason_short}
                                                fieldBold="סיבה:"
                                            />
                                        </CardContent>
                                    </CardActionArea>
