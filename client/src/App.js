				...
				<>
					...
					<Switch>
						...
						<Route
							...
							render={(props) => (
								<Scenes.AlertUnsubscribe {...props} />
							)}
						/>
						<Route
							path="/alerts/success"
							render={(props) => (
								<SuccessPaymentAlert {...props} />
							)}
						/>
						<Route
							path="/alerts"
							render={(props) => <Scenes.Alerts {...props} />}
						/>
						<Route
							path="/plan/:id"
						...
						<Route
							path="/my-plans"
							render={(props) => <UserPlans {...props} />}
						/>
						<Route
							path="/plans"
							render={(props) => <Scenes.Plans {...props} />}
						/>
						<Route
							path="/activate"
							render={(props) => <Scenes.Activate {...props} />}
						/>
						<Route
							path="/forgot"
							render={(props) => (
								<Scenes.ForgotPassword {...props} />
							)}
						/>
						<Route
							path="/support-us/success"
							render={(props) => <FundingSuccess {...props} />}
						/>
						<Route
							path="/support-us"
						...
						<Route
							path="/vocabulary"
							render={(props) => <Scenes.Vocabulary {...props} />}
						/>
						<Route
							path="/about"
							render={(props) => <Scenes.About {...props} />}
						/>
						<Route
							path="/trees"
							render={(props) => (
								<Scenes.TreePermits {...props} />
							)}
						/>
						<Route
							path="/trees-map"
							render={(props) => (
								<Scenes.TreePermitsMap {...props} />
							)}
						/>
						<Route
							path="/tree/:id"
						...
						<Route
							path="/terms"
							render={(props) => <Scenes.Terms {...props} />}
						/>
						<Route
							path="/privacy-policy"
							render={(props) => (
								<Scenes.PrivacyPolicy {...props} />
							)}
						/>
						<Route
							path="/404"
							render={(props) => <Scenes.NotFound {...props} />}
						/>
						<Route
							path="/email-sent"
						...
						<Route
							path="/hub"
							render={(props) => <UrbanPlanning {...props} />}
						/>
						<Route
							path="/permits/aoi"
							render={(props) => <AOI {...props} />}
						/>
						<Route
							path="/permits"
							render={(props) => <Permits {...props} />}
						/>
