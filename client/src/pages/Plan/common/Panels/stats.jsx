        ...
        <TabPanel>
            <TabBox>
                ...
                {textArea.exist !== 0 ? (
                    <>
                        <Text
                            text={`${t.thisPlanIncreases} `}
                            color={theme.palette.black}
                        />
                        <Text
                            text={`${renderMultiplier(textArea)} `}
                    ...
                    <>
                        <Text
                            text={`${t.thisPlanAdds} ${t.buildingLand}`}
                            color={theme.palette.black}
                        />
                        <Text
                            text={`${textArea.new} ${t.meter}`}
                ...
                />
                <Text
                    text={`${renderPercent(textArea.exist / textArea.area)}%`}
                    color={theme.palette.gray["alt"]}
                    weight="600"
                />
