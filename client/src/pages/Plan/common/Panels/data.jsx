    ...
    return (
        <TabPanel>
            <TabBox>
                ...
                <SC.Datalist>
                    <li key="number">מספר תוכנית: {number}</li>
                    <li key="type">סוג תוכנית: {type}</li>
                    {jurisdiction && (
                        <li key="jurisdiction">
                            מוסד התכנון המוסמך להפקיד את התכנית: וועדה{" "}
                            {jurisdiction}
                        </li>
                    )}
                    {depositingDate && (
                    ...
                    <li key="stationDesc">סטטוס: {stationDesc}</li>
                    <li key="lastUpdate">
                        עדכון אחרון:{" "}
                ...
                {!!notCredible && (
                    <div className="note">
                        שימו לב! זוהי תכנית המופקדת בסמכות מקומית. מכיוון
                        שהוועדות המקומיות לא מדווחות בצורה אחידה אודות הסטטוס של
                        התכניות בסמכותן אנחנו ממליצים לא להסתמך על סטטוס התכניות
                        (גם לא כמו שמופיע באתר "תכנון זמין"). התכנית עברה "תנאי
                        סף" וכנראה שהיא בהפקדה או תכף מופקדת
                    </div>
                )}
            </TabBox>
        </TabPanel>
