            ...
            <MainWrapper style>
                <ContentCol>
                    <Content>
                        ...
                        <Text id="register-emailsent-sucess">
                            שלחנו לך אימייל - לחיצה על הקישור שבתוכו תשלים את
                            הרשמתך
                        </Text>
                        <SmallTextWrapper>
                            ...
                            <Link
                                onClick={() =>
                                    resendActivationLinkToEmail(email)
                                }
                            >
                                לחצו כאן
                            </Link>
                ...
                <ImageCol>
                    <Image
                        src="./images/tolu-olubode-PlBsJ5MybGc-unsplash-3.jpg"
