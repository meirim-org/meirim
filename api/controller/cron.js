...
module.exports = {
  ...
  complete_mavat_data: () => Plan.query((qb) => {
    qb.where('main_details_from_mavat', '=', '');
  })
    .fetchAll()
    .then(planCollection => Bluebird.mapSeries(planCollection.models, (plan) => {
  ...
  complete_jurisdiction_from_mavat: () => Plan.query((qb) => {
...
const fetchIplan = iPlan => Plan.forge({
...
const buildPlan = (iPlan, oldPlan) => Plan
